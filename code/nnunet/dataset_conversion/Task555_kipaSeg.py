...
if __name__ == "__main__":
    ...
    downloaded_data_dir = "/media/milab-2080ti/ProgrammerOfCyz/kipa2022/nnUNet_raw_data_base/nnUNet_raw_data/kipa2022/train"
    ...
    for p in range(70):
        img = downloaded_data_dir + '/image/' + str(p) + '.nii.gz'
        seg = downloaded_data_dir + '/label/' + str(p) + '.nii.gz'
        ...
        shutil.copy(img, join(target_imagesTr, patient_name + "_0000.nii.gz"))
        shutil.copy(seg, join(target_labelsTr, patient_name + ".nii.gz"))

    json_dict = OrderedDict()
    json_dict['name'] = "Kipa_Seg"
    json_dict['description'] = "Kidney PArsing Challenge 2022: Multi-Structure Segmentation for Renal Cancer Treatment"
