...
def main():
    ...
    parser.add_argument('-o', '--output_folder', help="where to save the results", required=False, type=str)
    ...
    folders = ['/media/milab-2080ti/ProgrammerOfCyz/kipa2022/nnUNet_raw_data_base/nnUNet_raw_data/Task555_kipa/imagesTs']
    output_folder = '/media/milab-2080ti/ProgrammerOfCyz/kipa2022/ensemble_predict'
