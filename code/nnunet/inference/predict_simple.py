...
def main():
    ...
    # model = '2d'
    task_name = '555'
    input_folder = '/home/fengjie/FJ_data/kipa22/nnUNet_raw_data_base/nnUNet_raw_data/Task555_kipa/imagesTs'
    output_folder = '/home/fengjie/FJ_data/kipa22/nnUNet_raw_data_base/nnUNet_raw_data/Task555_kipa/predict'

    # input_folder = input_folder + '/' + 'fold_' + str(folds[0])
    # output_folder = output_folder + '/' + 'fold_' + str(folds[0])
